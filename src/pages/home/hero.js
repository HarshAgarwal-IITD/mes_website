...
return (
    <div className="w-100 vh-100" style={{ backgroundColor:"#001330"}}>
        ...
        <div className="w-100 h-100 d-flex justify-content-center align-items-center" style={{ position: "relative" }}>
            ...
            <img id="outer" src="/image/outer-gear.png" className="revolving-image"  style={{ position: "absolute", top: "13%", left: "1rem", transform: "translate(-50%, -50%)", height: "65%", width: "auto" }}></img>
