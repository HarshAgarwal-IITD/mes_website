...
const EventCards = ({ type }) => {
  ...
  const data = [
    ...
    { imageUrl: '/image/UG-Freshers.JPG', buttonText: "Fresher's Party", date: new Date("2024-03-12").toJSON().slice(0, 10), targetUrl: '/ug-orientation' },
    { imageUrl: '/image/Industry-visit.jpg', buttonText: "Industry Visit", date: new Date("2025-03-25").toJSON().slice(0, 10), targetUrl: '/industry-visit' },
    { imageUrl: '/image/Tryst.jpeg', buttonText: "Tryst", date: new Date("2025-03-22").toJSON().slice(0, 10), targetUrl: '/time-capsule' },
    ...
    { imageUrl: '/image/Seminar.jpeg', buttonText: "Research Seminar", date: new Date("2025-03-01").toJSON().slice(0, 10), targetUrl: '/cad-competition' },
    { imageUrl: '/image/Researchance.jpeg', buttonText: "Researchance", date: new Date("2025-03-27").toJSON().slice(0, 10), targetUrl: '/relay-race' },
    { imageUrl: '/image/egg1.jpeg', buttonText: "Don't Break the Egg", date: new Date("2025-04-03").toJSON().slice(0, 10), targetUrl: '/egg-break' },
    { imageUrl: '/image/study-beyond-borders.jpeg', buttonText: "Farewell", date: new Date("2025-03-20").toJSON().slice(0, 10), targetUrl: '/study-beyond-borders' },
